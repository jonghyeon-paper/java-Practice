...
public class DoubleLeftOuterJoinOneCondition {
    ...
    public static void main(String[] args) {
        ...
        // java - use seq, tuple and onEmpty
        Seq.seq(authorList.stream())
            .flatMap(v1 -> Seq.seq(bookList)
        ...
        // jool
        Seq.seq(authorList.stream())
            .leftOuterJoin(Seq.seq(bookList), (t, u) -> Objects.equals(t.getName(), u.getAuthor()))
            .forEach(System.out::println);
    }
}
